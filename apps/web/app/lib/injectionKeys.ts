...
export const tipMonaKey: InjectionKey<(destination: string, amount: number) => Promise<string>> = Symbol('tipMona')
export const updateMonaBalanceKey: InjectionKey<() => Promise<void>> = Symbol('updateMonaBalance')
