...
export const useApi = () => {
  ...
  const postMeBalanceRefresh = () => authedApiFetch<MeBalanceRefreshOk>('/me/balance/refresh', { method: 'POST' })
  ...
  // POST /tips
  const postTips = (body: TipsReqBody) => authedApiFetch<TipsOk>('/tips', { method: 'POST', body })
